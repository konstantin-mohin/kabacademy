...
<div class="container">
    <a href="/" class="logo"><img src="<?php echo get_template_directory_uri() ?>/static/img/donation/logo.svg" alt="logo"></a>
            ...
            <div class="row donation_raw">
                ...
                <div class="row progress-block">
                    <div class="col-md-7 pb-4 pb-md-0">
                            <span class="progress-block__title">
                    ...
                    <div class="col-md-5">
                        <div class="modal-wrapper">
                            ...
                            <a class="btn btn-primary progress-block__btn modal-button wlmodalgo">внести свой вклад</a>
                                    ...
                                    <form action="/checkout" class="variations_form cart" method="post" enctype="multipart/form-data" data-product_id="150236">
                                        ...
                                        <div class="cart__payments cart-payments wlcart-payments2" id="tabs">
											...
											foreach ($product->get_visible_children() as $variation_id) {
                                                ...
                                                <label class="cart-payments__item cart-payment wlcart-payment2  <?php if ($variation->price === '5') echo 'active'; ?>" id="tab-<?php echo $variation_id; ?>">
                                                    ...
                                                    <input type="radio" class="cart-payment__input wlcart-payment__input" id="price-<?php echo $variation_id; ?>" name="variation_id" value="<?php echo $variation_id; ?>" <?php if ($variation->price === '5') echo 'checked'; ?>>
                                        ...
                                        <div class="cart__payments cart-payments wlcart-payments">
                                            ...
                                            <div class="wlbutton-wrapper">
                                                <div class="btn btn-small button add-to form wlsubmit" style='margin-top: 10px;'>Отправить</div>
