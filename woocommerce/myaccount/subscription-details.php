...
<table class="shop_table subscription_details">
	<tbody>
		<tr>
			...
			<td class="subscription_details_status"><?php echo esc_html( wcs_get_subscription_status_name( $subscription->get_status() ) ); ?></td>
		</tr>
			...
			<tr>
				...
				<td>
					<?php foreach ( $actions as $key => $action ) : ?>
						<a class="subscription_action_link" href="<?php echo esc_url( $action['url'] ); ?>" class="button <?php echo sanitize_html_class( $key ) ?>"><?php echo esc_html( $action['name'] ); ?></a>
					<?php endforeach; ?>
				</td>
			</tr>
		<?php endif; ?>
