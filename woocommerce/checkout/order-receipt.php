...
<div class="order_details order-receipt-details">
	<div class="order order-receipt-item">
		<div class="order-receipt-item-left"><?php esc_html_e( 'Order number:', 'woocommerce' ); ?> <strong><?php echo esc_html( $order->get_order_number() ); ?></strong></div>
<!--		<div class="order-receipt-item-right"></div>-->
	</div>
	<div class="date order-receipt-item">
		<div class="order-receipt-item-left"><?php esc_html_e( 'Date:', 'woocommerce' ); ?> <strong><?php echo esc_html( wc_format_datetime( $order->get_date_created() ) ); ?></strong></div>
