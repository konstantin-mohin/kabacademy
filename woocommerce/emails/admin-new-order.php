            ...
            <td style="padding:60px 8%">
                <table width="100%" cellpadding="0" cellspacing="0" style="border-spacing:0">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-family:'Open Sans',sans-serif;font-size:14px;line-height:200%;color:#3c5d90"> Вы получили следующий заказ от <?php echo $name; ?>. </td>
                        </tr>
                        <!--tr>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f9fd;font-family:Montserrat,sans-serif">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding:15px 13px 35px 28px;width:213px;font-weight:500;font-size:16px;line-height:140%;color:#3c5d90;text-align:left;vertical-align:top"> <b>Основы каббалы. Часть 1</b> </td>
                                            <td style="padding:15px 13px;width:136px;font-weight:500;font-size:16px;line-height:140%;color:#3c5d90;text-align:left;vertical-align:top"> 30.23.2020 </td>
                                            <td style="padding:15px 13px;width:140px;font-weight:500;font-size:16px;line-height:140%;color:#3c5d90;text-align:left;vertical-align:top"> <a href="#" style="color:#a42bb9;font-weight:400;text-decoration:underline"> Учебник </a> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
